      ...
      </div>
      {
        destinationItem && (
          <div>
            ...
            <span className="absolute top-52 left-[62%] font-normal text-9xl text-white">{destinationItem.name}</span>
            <p className="absolute top-[55%] left-[63%] w-96 text-slate-400">{destinationItem.description}</p>
            <div className="h-1 w-96 absolute bottom-40 left-[63%] bg-[#ffffff1a]"></div>
